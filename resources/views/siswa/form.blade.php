 ...
 <!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        ...
        <small>SMK TUNAS JAKASAMPURNA BEKASI</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <div class="box">
        <div class="box-header with-border">
          <a href="{{ url('siswa') }}" class="btn btn-purple"><i class="fa fa-chevron-left"></i>Kembali</a>
        </div>
        ...
        <div class="box-body">
          <form action="{{ empty($result) ? url('siswa/add') : url("siswa/$result->nis/edit") }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" name="no_telp" class="form-control" placeholder="Masukkan Nomor Telpon" value="{{ @$result->no_telp }}">
              </div>
            </div>
